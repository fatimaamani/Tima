...
CREATE TABLE covid(
    ...
    sickness date,
    vaccin character varying(255),
    doses numeric,
    id integer NOT NULL,
    role character varying(255) NOT NULL,
    periodeconfinement character varying(255),
    datefinconfinement date,
    datevac date,
...
CREATE SEQUENCE covid_seq
    ...
    SELECT pg_catalog.setval('covid_seq', 1, true);
...
CREATE TABLE entry_test (
    ...
    niveau character varying NULL,
    date_entry date NOT NULL,
    CONSTRAINT entry_test_pkey PRIMARY KEY (id)
);

CREATE SEQUENCE entry_test_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    ...
    SELECT pg_catalog.setval('entry_test_seq', 1, true);
...
INSERT INTO config VALUES (0, 'VERSION', '4.3.2');
...
INSERT INTO profile_exceptions VALUES (1, 'Covid/Resources.php', 'Y', 'Y');
INSERT INTO profile_exceptions VALUES (1, 'Covid/CovidResource.php', 'Y', 'Y');
INSERT INTO profile_exceptions VALUES (0, 'Covid/CovidWidget.php', 'Y', NULL);
INSERT INTO profile_exceptions VALUES (1, 'Covid/CovidWidget.php', 'Y', NULL);
INSERT INTO profile_exceptions VALUES (2, 'Covid/CovidWidget.php', 'Y', NULL);
INSERT INTO profile_exceptions VALUES (3, 'Covid/CovidWidget.php', 'Y', NULL);
INSERT INTO profile_exceptions VALUES (1, 'Covid/Vaccination.php', 'Y', 'Y');
INSERT INTO profile_exceptions VALUES (1, 'Covid/Doses.php', 'Y', 'Y');
INSERT INTO profile_exceptions VALUES (1, 'Covid/PeriodeConfinement.php', 'Y', 'Y');
INSERT INTO profile_exceptions VALUES (1, 'Covid/HistoriqueInfectionEleve.php', 'Y', 'Y');
INSERT INTO profile_exceptions VALUES (1, 'Covid/HistoriqueInfectionPersonnels.php', 'Y', 'Y');
INSERT INTO profile_exceptions VALUES (1, 'Covid/HistoriqueVaccinationEleve.php', 'Y', 'Y');
INSERT INTO profile_exceptions VALUES (1, 'Covid/HistoriqueVaccinationPersonnels.php', 'Y', 'Y');
INSERT INTO profile_exceptions VALUES (1, 'Covid/Setup.php', 'Y', 'Y');



INSERT INTO profile_exceptions VALUES (1, 'EntryTest/EntryTestWidget.php', 'Y', 'Y');
INSERT INTO profile_exceptions VALUES (1, 'EntryTest/EntryTestResource.php', 'Y', 'Y');
INSERT INTO profile_exceptions VALUES (1, 'EntryTest/CollegeLevel.php', 'Y', 'Y');
INSERT INTO profile_exceptions VALUES (1, 'EntryTest/PrimaryLevel.php', 'Y', 'Y');

INSERT INTO profile_exceptions VALUES (0, 'EntryTest/EntryTestWidget.php', 'Y', NULL);
INSERT INTO profile_exceptions VALUES (0, 'EntryTest/EntryTestResource.php', 'Y', NULL);
INSERT INTO profile_exceptions VALUES (0, 'EntryTest/PrimaryLevel.php', 'Y', NULL);
INSERT INTO profile_exceptions VALUES (0, 'EntryTest/CollegeLevel.php', 'Y', NULL);

INSERT INTO profile_exceptions VALUES (2, 'EntryTest/EntryTestWidget.php', 'Y', NULL);
INSERT INTO profile_exceptions VALUES (2, 'EntryTest/EntryTestResource.php', 'Y', NULL);
INSERT INTO profile_exceptions VALUES (2, 'EntryTest/PrimaryLevel.php', 'Y', NULL);
INSERT INTO profile_exceptions VALUES (2, 'EntryTest/CollegeLevel.php', 'Y', NULL);

INSERT INTO profile_exceptions VALUES (3, 'EntryTest/EntryTestWidget.php', 'Y', NULL);
INSERT INTO profile_exceptions VALUES (3, 'EntryTest/EntryTestResource.php', 'Y', NULL);
INSERT INTO profile_exceptions VALUES (3, 'EntryTest/PrimaryLevel.php', 'Y', NULL);
INSERT INTO profile_exceptions VALUES (3, 'EntryTest/CollegeLevel.php', 'Y', NULL);
...
CREATE INDEX covid_ind ON covid USING btree (id);
...
CREATE INDEX entry_test_ind ON entry_test USING btree (id);
